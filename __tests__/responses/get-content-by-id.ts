...
export const getPageById: ConfluenceApiGetContentByIdData = {
  ...
  version: {
    ...
    _links: {
      self: "https://fakewiki.atlassian.net/wiki/rest/api/content/123456789/version/8",
    },
  },
  macroRenderedOutput: {},
...
export const errorFromId: ConfluenceApiError = {
  ...
  data: {
    ...
    errors: [
      {
        message: {
          translation: "No content found with id : 212992029",
          args: [],
        },
      },
    ],
  ...
  message:
    "com.atlassian.confluence.api.service.exceptions.NotFoundException: No content found with id : 212992029",
};
